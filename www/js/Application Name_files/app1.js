...
window.globalVariable = {
    ...
    startPage: {
        url: "/app/profileUser",//Url of start page.
        state: "app.profileUser"//State name of start page.
    },
    message: {
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        $stateProvider
           ...
           .state('app.profileUser', {
                       ...
                       views: {
                         'menuContent':{
                           templateUrl: 'hackathon/ProfileUser/profileUser.html',
            ...
            .state('meteo', {
                         url: '/meteo',
                         templateUrl: 'hackathon/quickMeteo/meteo.html',
