...
angular.module('starter', ['ionic','ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services','starter.directives' ,'ngMaterial', 'ngMessages', 'ngCordova'])
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        appPrimaryColor = "#458ac6" //Use for get base color of theme.
        ...
        $stateProvider
            .state('app', {
                url: "/app",
                abstract: true,
                templateUrl: "templates/menu1/html/menu.html",
                controller: 'menuCtrl'
            })
            .state('app.dashboard', {
                url: "/dashboard",
        ...
        .state('app.products', {
                    ...
                    views: {
                      'menuContent':{
                        templateUrl: 'templates/courses/products.html',
                        controller: 'productsCtrl'
                      }
                    }
                })
        .state('app.mapNavigation', {
                  url: '/map',
                  cache: false,
                   views: {
                    'menuContent': {
                        templateUrl: 'templates/mapNavigation/Mapnavigate.html',
       ...
       .state('app.magasins', {
                 ...
                 cache: false,
                  views: {
                   'menuContent': {
                       templateUrl: 'templates/magasins/magasins.html',
      ...
      .state('app.venues', {
                ...
                cache: false,
                 views: {
                  'menuContent': {
                      templateUrl: 'templates/magasins/venues.html',
